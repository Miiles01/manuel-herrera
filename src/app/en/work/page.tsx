      ...
      <main className="flex-1 pt-36 md:pt-48 pb-20">
        <section className="px-6 md:px-12 lg:px-20 container mx-auto mb-20 md:mb-32">
          <p className="text-xl md:text-2xl lg:text-3xl font-light tracking-tight max-w-3xl mb-6 text-black leading-relaxed fade-up-hero opacity-0">
            I design with purpose for brands seeking authenticity and scalability.
          </p>
              ...
              <div key={slug} id={slug} className="mb-28 md:mb-40 group project-item">
                ...
                <div className="px-2 md:px-4 flex flex-col md:flex-row md:items-end justify-between gap-4 project-fade-up opacity-0">
                  <div className="max-w-2xl">
                    <TransitionLink href={`/en/project/${slug}`} className="inline-flex items-center gap-2 group/title">
                  ...
                  <TransitionLink href={`/en/project/${slug}`} className="inline-flex items-center gap-1.5 text-xs font-normal uppercase tracking-widest text-gray-400 hover:text-black transition-colors pt-2 md:pt-0">
